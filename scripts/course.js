const courses = [
    ...
    },
    {
        ...
        completed: true,
        weeks: [
            "Week 01 - Setup, Introduction to HTML.",
            "Week 02 - Introduction to CSS.",
            "Week 03 - CSS Layouts.",
            "Week 04 - CSS Flex, CSS Grid.",
            "Week 05 - HTML Tables, HTML Forms.",
            "Week 06 - Careers, Project Completion.",
            "Week 07 - Exam."
        ]
    },
    {
...
function renderCourse (courseList) {
    ...
    courseList.forEach( (course) => {
        ...
        courseBtn.addEventListener('click', () => {
            const detailsContainer = document.querySelector('#courseDetails');
            detailsContainer.classList.add('courseDeta')
